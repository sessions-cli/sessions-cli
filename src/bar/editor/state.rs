...
pub struct TextEditor {
    ...
    /// Absolute `[` index in note text — backspace demoted checkbox to literal markdown.
    pub checkbox_literal_edit: Option<usize>,
    /// Hide the terminal cursor after a checkbox click until the user edits elsewhere.
    pub suppress_terminal_cursor: bool,
}
...
impl TextEditor {
    ...
    pub fn clear_interaction(&mut self) {
        ...
        self.checkbox_literal_edit = None;
        self.suppress_terminal_cursor = false;
    }
