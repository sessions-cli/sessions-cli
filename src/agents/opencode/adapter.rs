...
use super::disk::{
    ...
    opencode_data_dir, opencode_db_path, opencode_session_index, open_readonly, session_activity_at,
    session_cwd_for_id, session_exists, session_messaged_at, thread_title_from_summary,
};
